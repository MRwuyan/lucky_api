package com.exhk.robot.order.common.monitoring;
...
public class JavaMelodyConfiguration {
    ...
    public FilterRegistrationBean monitoringFilter(ServletContext servletContext) {
        ...
        //配置不生效，只能手动设置了
        registrationBean.addInitParameter(Parameter.AUTHORIZED_USERS.getCode(), "admin:Hezong-2018");
       ...
       /*     for ( Map.Entry<String, String> entrys : registrationBean.getInitParameters() .entrySet()) {
                filterRegistration.setInitParameter(entrys.getKey(), entrys.getValue());
            }
*/
            for ( Object entrys : registrationBean.getInitParameters() .entrySet()) {
                Map.Entry<String, String> sss= (Map.Entry<String, String>) entrys;
                filterRegistration.setInitParameter(sss.getKey(), sss.getValue());
            }
